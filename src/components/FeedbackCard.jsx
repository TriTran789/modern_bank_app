...
const FeedbackCard = ({content, name, title, img}) => (
  <div className='flex justify-between flex-col px-10 py-12 rounded-[20-px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 feedback-card'>
    ...
    <div className="flex flex-row">
      <img src={img} alt={name} className="w-[48px] h-[48-px] rounded-full" />
